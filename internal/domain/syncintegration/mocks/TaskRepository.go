...
func (_e *TaskRepository_Expecter) GetTasks(ctx interface{}) *TaskRepository_GetTasks_Call {
	return &TaskRepository_GetTasks_Call{Call: _e.mock.On("GetTasks", ctx)}
}

func (_c *TaskRepository_GetTasks_Call) Run(run func(ctx context.Context)) *TaskRepository_GetTasks_Call {
...
func (_c *TaskRepository_GetTasks_Call) Return(_a0 entity.Tasks, _a1 error) *TaskRepository_GetTasks_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TaskRepository_GetTasks_Call) RunAndReturn(run func(context.Context) (entity.Tasks, error)) *TaskRepository_GetTasks_Call {
	_c.Call.Return(run)
	return _c
}
